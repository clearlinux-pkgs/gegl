...
%prep
%setup -q -n gegl-0.4.38
cd %{_builddir}/gegl-0.4.38
pushd ..
cp -a gegl-0.4.38 buildavx2
popd
pushd ..
cp -a gegl-0.4.38 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667425599
unset LD_AS_NEEDED
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgegl-0.4.so.0.437.1
...
/usr/lib64/glibc-hwcaps/x86-64-v4/libgegl-0.4.so.0.437.1
...
/usr/lib64/libgegl-0.4.so.0.437.1
