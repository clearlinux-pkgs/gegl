...
%prep
%setup -q -n gegl-0.4.24
cd %{_builddir}/gegl-0.4.24
pushd ..
cp -a gegl-0.4.24 buildavx2
popd
pushd ..
cp -a gegl-0.4.24 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591642178
unset LD_AS_NEEDED
...
cp %{_builddir}/gegl-0.4.24/COPYING %{buildroot}/usr/share/package-licenses/gegl/7181028b2cb15912d89c76ca33b720a3bfb537cc
cp %{_builddir}/gegl-0.4.24/COPYING.LESSER %{buildroot}/usr/share/package-licenses/gegl/e7d563f52bf5295e6dba1d67ac23e9f6a160fab9
cp %{_builddir}/gegl-0.4.24/subprojects/libnsgif/COPYING %{buildroot}/usr/share/package-licenses/gegl/91664a5e5a2b5bf020a621d0e9c5cc507e619c94
cp %{_builddir}/gegl-0.4.24/subprojects/poly2tri-c/COPYING %{buildroot}/usr/share/package-licenses/gegl/7cd64aeec55f96676d9e34b6b1677ec470e45fcf
cp %{_builddir}/gegl-0.4.24/subprojects/poly2tri-c/LICENSE-Poly2Tri-C.txt %{buildroot}/usr/share/package-licenses/gegl/855d3492027e24b96cc759b7fa729176cb1bdca7
cp %{_builddir}/gegl-0.4.24/subprojects/poly2tri-c/LICENSE-Poly2Tri.txt %{buildroot}/usr/share/package-licenses/gegl/178f030d76bde249653291b58a7e8066755051be
...
/usr/lib64/libgegl-0.4.so.0.423.1
