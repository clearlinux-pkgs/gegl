...
Source0  : https://download.gimp.org/pub/gegl/0.4/gegl-0.4.8.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1534610265
export AR=gcc-ar
...
/usr/lib64/libgegl-0.4.so.0.408.0
