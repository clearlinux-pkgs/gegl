...
Source0  : https://download.gimp.org/pub/gegl/0.4/gegl-0.4.6.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1534029854
export AR=gcc-ar
...
/usr/lib64/libgegl-0.4.so.0.406.0
