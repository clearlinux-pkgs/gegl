...
%prep
%setup -q -n gegl-0.4.42
cd %{_builddir}/gegl-0.4.42
pushd ..
cp -a gegl-0.4.42 buildavx2
popd
pushd ..
cp -a gegl-0.4.42 buildavx512
popd
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libgegl-0.4.so.0.441.1
...
/usr/lib64/glibc-hwcaps/x86-64-v4/libgegl-0.4.so.0.441.1
...
/usr/lib64/libgegl-0.4.so.0.441.1
